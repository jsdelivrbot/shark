        ...
        <div class="cms-content">
            <el-collapse v-model="activeName">
                <el-collapse-item title="资源产出消耗" name="0">
                    <ele-form :config="gold_product_config" v-on:receive="gold_product_submit"
                              :defaultdata="goldProductHtml"></ele-form>
                    <table-option :parent-message="product_Msg" v-on:message="productMessage"
                                  v-on:pagedata="productChangePage" v-loading="productloading"
                                  element-loading-text="拼命加载中"></table-option>
                </el-collapse-item>
                <el-collapse-item title="道具产出消耗" name="1">
                    <ele-form :config="item_product_config" v-on:receive="item_product_submit"
                              :defaultdata="itemProductHtml"></ele-form>
                    <table-option :parent-message="item_Msg" v-on:message="itemMessage" v-loading="productloading2"
                                  element-loading-text="拼命加载中"></table-option>
                </el-collapse-item>
            </el-collapse>
        </div>
