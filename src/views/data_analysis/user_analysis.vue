                ...
                <el-tab-pane label="新增用户" name="0">
                    <el-collapse v-model="newUserName">
                        <el-collapse-item title="概况" name="0">
                            ...
                            <table-option :parent-message="newUserSurvey_Msg" v-on:message="newUserSurveyMessage" v-loading="loading1" element-loading-text="拼命加载中"></table-option>
                        </el-collapse-item>
                ...
                <el-tab-pane label="活跃用户" name="1">
                    <el-collapse v-model="acUserName">
                        <el-collapse-item title="概况" name="0">
                            ...
                            <table-option :parent-message="acUserSurvey_Msg" v-on:message="acUserSurveyMessage" v-loading="loading3" element-loading-text="拼命加载中"></table-option>
                        </el-collapse-item>
                        <el-collapse-item title="活跃列表" name="1">
                            ...
                            <table-option :parent-message="active_Msg" v-on:message="activeMessage" v-loading="loading4" element-loading-text="拼命加载中"></table-option>
                        </el-collapse-item>
                    </el-collapse>
                </el-tab-pane>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            newUserSurveyMessage(text) {
                this.newUserSurvey_Msg.data = tableSearch(text, this.newUserSurvey_Msg.data);
            },
            /* 新增列表 */
            new_user_submit(arg) {
                let _self = this;
            ...
            acUserSurveyMessage(text) {
                this.acUserSurvey_Msg.data = tableSearch(text, this.acUserSurvey_Msg.data);
            },
            /* 活跃列表 */
            active_submit(arg) {
                let _self = this;
