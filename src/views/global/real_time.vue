        ...
        <div class="cms-content">
            <el-tabs type="border-card">
                ...
                <el-tab-pane label="金币分布">
                    <ele-form :config="gold_dis_config" v-on:receive="gold_dis_submit" :defaultdata="goldDefaultHtml"></ele-form>
                    <table-option :parent-message="goldCoin_Msg" v-loading="goldCoinloading" element-loading-text="拼命加载中"></table-option>
                    <br/>
                    <br/>
                ...
                <el-tab-pane label="流失玩家">
                    ...
                    <table-option :parent-message="loss_Msg" v-on:message="lossMessage" v-loading="lossloading" element-loading-text="拼命加载中"></table-option>
                </el-tab-pane>
            </el-tabs>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        online_submit(arg) {
            this.loading2 = true;
            this.$res.postData(this, '/Realtime/query_online_player/', arg[0]).then((response) => {
    ...
    created() {
        ...
        /* 在线人数统计 - 查询 */
        _self.$res.postData(_self, '/Realtime/query_online_player/', {
