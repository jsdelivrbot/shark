<template>
    <div id="container">
        ...
        <!-- 落地页管理 -->
        <el-dialog title="新增落地页模板" size="tiny" :visible.sync="createLdyFormDialog">
        ...
        <el-dialog title="修改落地页模板" size="tiny" :visible.sync="editLdyFormDialog">
        ...
        <!-- 渠道管理 -->
        <el-dialog title="新增渠道" size="tiny" :visible.sync="createChannelFormDialog">
        ...
        <el-dialog title="编辑渠道" size="tiny" :visible.sync="editChannelFormDialog">
